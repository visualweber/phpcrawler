...
use PHPCrawler\PHPCrawlerHtmlDom\PHPCrawlerHtmlDom;
...
class PHPCrawlerUtils {
     ...
     * @return \PHPCrawler\PHPCrawlerHtmlDom|boolean
     */
    public static function file_get_html($url, $use_include_path = false, $context = null, $offset = -1, $maxLen = -1, $lowercase = true, $forceTagsClosed = true, $target_charset = self::DEFAULT_TARGET_CHARSET, $stripRN = true, $defaultBRText = self::DEFAULT_BR_TEXT, $defaultSpanText = self::DEFAULT_SPAN_TEXT) {
        ...
        $dom = new PHPCrawlerHtmlDom(null, $lowercase, $forceTagsClosed, $target_charset, $stripRN, $defaultBRText, $defaultSpanText);
    ...
    /**
     * @Desc Search elements that contains an specific text
     * 
     * @param type $html
     * @param type $selector
     * @param type $keyword
     ...
     * @return type
     */
    public static function find_contains($html, $selector, $keyword, $index = -1) {
        $ret = array();
