...
namespace PHPCrawler\PHPCrawlerHtmlDom;

class PHPCrawlerHtmlDom {
    ...
    protected function prepare($str, $lowercase = true, $stripRN = true, $defaultBRText = self::DEFAULT_BR_TEXT, $defaultSpanText = self::DEFAULT_SPAN_TEXT) {
        ...
        $this->root = new PHPCrawlerHtmlDomNode($this);
        $this->root->tag = 'root';
    ...
    protected function parse() {
        ...
        // text
        $node = new PHPCrawlerHtmlDomNode($this);
        ++$this->cursor;
    ...
    protected function read_tag() {
        ...
        if ($this->char === '/') {
            $this->char = ( ++$this->pos < $this->size) ? $this->doc[$this->pos] : null; // next
            // This represents the change in the PHPCrawlerHtmlDom trunk from revision 180 to 181.
