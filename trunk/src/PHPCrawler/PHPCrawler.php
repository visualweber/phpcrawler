...
/**
 * PHPCrawler mainclass
 *
 * @package phpcrawler
 * @author XGOON MEDIA (contact@xgoon.com)
 * @version 0.82
 * @License GPL2
 */
...
use PHPCrawler\PHPCrawlerUserSendDataCache;
use PHPCrawler\PHPCrawlerURLDescriptor;
use PHPCrawler\PHPCrawlerHTTPRequest;
use PHPCrawler\PHPCrawlerURLFilter;
use PHPCrawler\PHPCrawlerRobotsTxtParser;
...
class PHPCrawler {
    ...
    // Enable clear cookies on each request
    protected $cookie_clear = true;
    // Enable clear post-datas on each request
    protected $cookie_postdata = true;
    ...
    public function __construct() {
        ...
        if (!class_exists("PHPCrawlerUtils"))
            include_once($classpath . "/PHPCrawlerUtils.php");

        // URL-Cache-classes
        //if (!class_exists("PHPCrawlerURLCacheBase"))
        //    include_once($classpath . "/UrlCache/PHPCrawlerURLCacheBase.php");
        //if (!class_exists("PHPCrawlerMemoryURLCache"))
        //    include_once($classpath . "/UrlCache/PHPCrawlerMemoryURLCache.php");
        //if (!class_exists("PHPCrawlerSQLiteURLCache"))
        //    include_once($classpath . "/UrlCache/PHPCrawlerSQLiteURLCache.php");
        // PageRequest-class
        //if (!class_exists("PHPCrawlerHTTPRequest"))
        //    include_once($classpath . "/PHPCrawlerHTTPRequest.php");
        ...
        //    include_once($classpath . "/CookieCache/PHPCrawlerCookieCacheBase.php");
        //if (!class_exists("PHPCrawlerMemoryCookieCache"))
        //    include_once($classpath . "/CookieCache/PHPCrawlerMemoryCookieCache.php");
        //if (!class_exists("PHPCrawlerSQLiteCookieCache"))
        //    include_once($classpath . "/CookieCache/PHPCrawlerSQLiteCookieCache.php");
        // URL-filter-class
        //if (!class_exists("PHPCrawlerURLFilter"))
        //    include_once($classpath . "/PHPCrawlerURLFilter.php");
        $this->UrlFilter = new PHPCrawlerURLFilter();

        // RobotsTxtParser-class
        //if (!class_exists("PHPCrawlerRobotsTxtParser"))
        //    include_once($classpath . "/PHPCrawlerRobotsTxtParser.php");
        $this->RobotsTxtParser = new PHPCrawlerRobotsTxtParser();

        // ProcessReport-class
        //if (!class_exists("PHPCrawlerProcessReport"))
        //   include_once($classpath . "/PHPCrawlerProcessReport.php");
        // UserSendDataCache-class
        //if (!class_exists("PHPCrawlerUserSendDataCache"))
        //    include_once($classpath . "/PHPCrawlerUserSendDataCache.php");
        $this->UserSendDataCache = new PHPCrawlerUserSendDataCache();

        // URLDescriptor-class
        //if (!class_exists("PHPCrawlerURLDescriptor"))
        //    include_once($classpath . "/PHPCrawlerURLDescriptor.php");
        // PageInfo-class
        //if (!class_exists("PHPCrawlerDocumentInfo"))
        //    include_once($classpath . "/PHPCrawlerDocumentInfo.php");
        // Benchmark-class
        //if (!class_exists("PHPCrawlerBenchmark"))
        //    include_once($classpath . "/PHPCrawlerBenchmark.php");
        // URLDescriptor-class
        //if (!class_exists("PHPCrawlerUrlPartsDescriptor"))
        //    include_once($classpath . "/PHPCrawlerUrlPartsDescriptor.php");
        // CrawlerStatus-class
        //if (!class_exists("PHPCrawlerStatus"))
        //    include_once($classpath . "/PHPCrawlerStatus.php");
        // AbortReasons-class
        //if (!class_exists("PHPCrawlerAbortReasons"))
        //    include_once($classpath . "/Enums/PHPCrawlerAbortReasons.php");
        // RequestErrors-class
        //if (!class_exists("PHPCrawlerRequestErrors"))
        //    include_once($classpath . "/Enums/PHPCrawlerRequestErrors.php");
        // PHPCrawlerUrlCacheTypes-class
        //if (!class_exists("PHPCrawlerUrlCacheTypes"))
        //   include_once($classpath . "/Enums/PHPCrawlerUrlCacheTypes.php");
        // PHPCrawlerMultiProcessModes-class
        //if (!class_exists("PHPCrawlerMultiProcessModes"))
        //    include_once($classpath . "/Enums/PHPCrawlerMultiProcessModes.php");
        // PHPCrawlerProcessHandler-class
        //if (!class_exists("PHPCrawlerProcessHandler"))
        //    include_once($classpath . "/ProcessCommunication/PHPCrawlerProcessHandler.php");
        // PHPCrawlerStatusHandler-class
        //if (!class_exists("PHPCrawlerStatusHandler"))
        //    include_once($classpath . "/ProcessCommunication/PHPCrawlerStatusHandler.php");
        // PHPCrawlerDocumentInfoQueue-class
        //if (!class_exists("PHPCrawlerDocumentInfoQueue"))
        //    include_once($classpath . "/ProcessCommunication/PHPCrawlerDocumentInfoQueue.php");
    ...
    protected function processUrl(PHPCrawlerURLDescriptor $UrlDescriptor) {
        ...
        if ($this->cookie_clear):
            $this->PageRequest->clearCookies();
        endif;

        if ($this->cookie_postdata):
     ...
     * @param type $clear
     */
    public function setClearPostDatas($mode) {
        // Remove post-data from request-object
        if (!is_bool($mode))
            return false;

        $this->cookie_postdata = $mode;
        return true;
    }
     ...
     * @param type $clear
     */
    public function setClearCookies($mode) {
        // Remove cookie-data from request-object
        if (!is_bool($mode))
            return false;

        $this->cookie_clear = $mode;
        return true;
    }
